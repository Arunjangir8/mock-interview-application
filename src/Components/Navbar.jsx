    ...
    >
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <span className="ml-3 font-bold text-xl text-[#374151]">
              <span className="text-[#BE5959]">Navigate </span>
              <span>Growth</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {token ? (
              <div className="relative group ml-6 cursor-pointer">
                ...
                <div className="absolute top-0 right-0 pt-12 hidden group-hover:block z-20">
                  <div className="bg-white rounded-lg shadow-lg p-3 w-40">
                    ...
                    <p onClick={() => setToken(false)} className="dropdown-item text-red-500 hover:bg-red-50">Logout</p>
                  </div>
                </div>
              </div>
            ) : (
              <a
                href="/login"
                className="ml-6 px-6 py-2 bg-[#BE5959] text-white font-medium rounded-lg shadow hover:bg-[#a94444] transition-all duration-300"
              >
                Sign Up
              </a>
            )}
      ...
      >
        <div className="px-4 py-3 space-y-2">
          <a href="/home" className="mobile-link text-[#374151] hover:text-[#BE5959]">Home</a>
          ...
          {token ? (
            <div className="pt-2 space-y-2">
              ...
              <button
                ...
                className="mobile-link text-left text-red-500 hover:bg-red-50"
              >
                Logout
              </button>
            </div>
            ...
            <a
              href="/login"
              className="block w-full px-4 py-3 bg-[#BE5959] text-white text-center font-medium rounded-lg shadow hover:bg-[#a94444] transition-all duration-300 mt-4"
            >
              Sign Up
            </a>
          )}
