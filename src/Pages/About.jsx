...
function About() {
  ...
  return (
    <div className="font-sans">
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white py-20 px-6 lg:px-16 lg:pt-52 h-[100vh] ">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <button 
                onClick={goToHome}
                className="text-center px-8 py-3 rounded-full bg-[#be5959] shadow-lg shadow-[#be5959]/30 transition-all duration-300 ease-in-out hover:shadow-xl hover:shadow-[#be5959]/50 hover:-translate-y-0.5 text-white font-medium"
              >
      ...
      <section className="py-20 px-6 lg:px-16 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center mb-20 lg:mt-32">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center lg:mt-24">
      ...
      <section className="py-20 px-6 lg:px-16 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/521876/target.svg"
              title="Quality Practice" 
              description="We ensure our interview questions and scenarios reflect real-world hiring practices." 
            />
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/501336/reset.svg"
              title="Continuous Learning" 
              description="Our platform adapts to your performance, helping you focus on areas that need improvement." 
            />
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/500529/data-line.svg"
              title="Data-Driven Feedback" 
              description="Get insights on your responses backed by research and industry best practices." 
            />
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/425600/growth-report-graph.svg"
              title="Growth Mindset" 
              description="We encourage users to see interviews as opportunities to learn and improve." 
            />
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/532392/user-shield.svg"
              title="Privacy First" 
              description="Your practice data and responses are protected and never shared without permission." 
            />
            <CommitmentCard 
              icon="https://www.svgrepo.com/show/399613/accessibility.svg"
              title="Accessibility" 
              description="Our platform is designed to be usable by everyone, regardless of ability." 
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              The numbers that drive us to do more every day
            </p>
          </div>
      ...
      <section className="py-20 px-6 lg:px-16 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              onClick={goToHome}
              className="px-8 py-3 rounded-full bg-[#be5959] shadow-lg shadow-[#be5959]/30 transition-all duration-300 ease-in-out hover:shadow-xl hover:shadow-[#be5959]/50 hover:-translate-y-0.5 text-white font-medium"
            >
              Start Practicing
            </button>
            <button
            onClick={()=>{navigate("/home"); scrollTo(0,0)}}
             className="px-8 py-3 rounded-full border-2 border-gray-300 transition-all duration-300 ease-in-out hover:border-gray-400 hover:-translate-y-0.5 text-gray-700 font-medium">
              Learn More
            </button>
          </div>
        </div>
...
function CommitmentCard({ icon, title, description }) {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      <img src={icon} alt="" className="text-4xl mb-4 w-[80px] h-[80px]"/>
